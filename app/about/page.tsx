export default function About() {
  return (
    <section data-oid="usy2r0_" className="space-y-8">
      <div data-oid="pvudhpd">
        <h1
      ...
      <div className="space-y-6" data-oid="wrllna5">
        <div
      ...
      {/* Skills Section */}
      <div className="space-y-6" data-oid="1r_ejf_">
        <h2
        ...
        <div
          ...
          data-oid="6x4o0wg"
        >
          <div className="space-y-4" data-oid="bvat8wc">
            <h3
            ...
            <div className="space-y-3" data-oid="m06aiax">
              {[
                { name: "React", level: 85 },
                ...
                <div key={skill.name} className="space-y-2" data-oid="ztypgdh">
                  <div className="flex justify-between" data-oid="lh96voo">
                    <span className="text-sm font-medium" data-oid="8xu1vi8">
                      {skill.name}
                    </span>
                    <span
          ...
          <div className="space-y-4" data-oid="alfieqs">
            <h3
            ...
            <div className="space-y-3" data-oid="el:2oef">
              {[
                ...
                <div key={skill.name} className="space-y-2" data-oid="hn0av7_">
                  <div className="flex justify-between" data-oid="gmueygi">
                    <span className="text-sm font-medium" data-oid="jdy0dbv">
                      {skill.name}
                    </span>
                    <span
                      className="text-sm text-neutral-500"
      ...
      {/* Interests */}
      <div className="space-y-6" data-oid="wy4jfk6">
        <h2
          className="text-2xl font-semibold tracking-tight"
          data-oid="aaa7ds9"
        >
        ...
        >
          {[
            ...
            <div
              ...
              data-oid="m3y5txb"
            >
              <div className="text-3xl mb-3" data-oid="l8zu0ko">
                {interest.icon}
              </div>
              <h3 className="font-semibold mb-2" data-oid="s3n70_h">
                {interest.title}
              </h3>
              <p
      ...
      <div className="space-y-6" data-oid="76p2o-s">
        <h2
          className="text-2xl font-semibold tracking-tight"
          data-oid="pxhf.km"
        >
        ...
        <div className="space-y-4" data-oid="16abrjj">
          <div
          ...
          >
            <div
              ...
              data-oid="xlt5yav"
            >
              <h3 className="font-semibold" data-oid="xj1orz8">
                소프트웨어 엔지니어링 전공
              </h3>
              <span
          ...
          <div
            ...
            data-oid="cn551-y"
          >
            <h3 className="font-semibold mb-2" data-oid="3wgg4cv">
              개인 프로젝트 개발
            </h3>
            <p
              className="text-sm text-neutral-600 dark:text-neutral-400"
