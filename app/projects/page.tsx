...
const projects = [
  ...
  },
  {
    ...
    status: "완료",
    driveLink: "https://drive.google.com/drive/folders/1rHhize6eWd5lQdWBhbV53sozMsesRcxS?usp=drive_link",
  },
];
...
export default function Projects() {
  return (
    <section className="space-y-8">      <div>
        <h1 className="mb-4 text-3xl font-bold tracking-tight">Projects</h1>        <p className="text-lg text-[var(--text-secondary)]">
      ...
      <div className="space-y-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">          {projects.map((project, index) => (            <div
              key={index}
      ...
      <div className="p-6 rounded-xl bg-[var(--color-2)] border border-[var(--color-3)]">
        <div className="text-center space-y-4">
          <h3 className="text-xl font-semibold text-[var(--text-primary)]">더 많은 프로젝트</h3>
